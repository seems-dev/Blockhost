                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: _connected ? [BoxShadow(color: _accent.withOpacity(0.2), blurRadius: 8)] : [],
                        ),
                        child: Row(
                          ...
                          children: [
                            Container(
                              width: 6, height: 6, 
                              decoration: BoxDecoration(
                                color: _connected ? _accent : Colors.orange, 
                                shape: BoxShape.circle,
                                boxShadow: _connected ? [BoxShadow(color: _accent, blurRadius: 4)] : [],
                              ),
                            ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    const Icon(Icons.terminal_rounded, color: _accent, size: 14),
                                    const SizedBox(width: 8),
                                    const Text('LATEST.LOG', style: TextStyle(color: _accent, fontSize: 12, fontWeight: FontWeight.bold, letterSpacing: 1)),
                                    const Spacer(),
                                    Row(
                                      children: [
                                ...
                                child: Container(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, i) {
                                      ...
                                      final textColor = isSystem ? Colors.orangeAccent : _textGreen;
